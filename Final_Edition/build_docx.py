...
SRC = os.path.join(os.path.dirname(__file__), 'source', 'Essential_Histology_Canonical_Source.md')
IMG_DIR = os.path.join(os.path.dirname(__file__), 'source', 'images')
OUT = os.path.join(os.path.dirname(__file__), 'Essential_Histology_Definitive_Edition.docx')
